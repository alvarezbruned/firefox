...
RUN sed -i 's/wait $NODE_PID/firefox -silent -install-global-extension addon-2079-latest.xpi -setDefaultBrowser www.google.es wait $NODE_PID/g' /opt/bin/entry_point.sh
